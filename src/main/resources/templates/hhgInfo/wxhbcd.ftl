...
<html >
	<head>
		...
		<script type="text/javascript" src="${request.contextPath}/js/jquery.countdown.min.js"></script> 
        <script type="text/javascript" src="${request.contextPath}/js/jquery.custom.js"></script>
...
//					console.log($(".li" + nums).css("left"));
	...
	<body>
		...
		<div class="container">-->
			<div class="clock">
			    <div class="span6"> <img class="img-clock" src="${request.contextPath}/image/bg-clock.png" alt="clock counter" />
			      <div id="countdown">
