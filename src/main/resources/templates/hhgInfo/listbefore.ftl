...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">历史信息列表</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row --> 
        	...
        	<div class="col-lg-12"> 
				<div class="panel panel-default">
                    <div class="panel-body">
                       <p>
                		<#--<a href="${request.contextPath}/hhg/create" class="btn btn-default" >历史发布信息</a>-->
...
$(document).ready(function (){
   ...
   var dataTable_config = {//jquery_datatable插件的默认参数皮质
		...
		"bServerSide": true,
		"responsive": true,
		"sAjaxSource": "${request.contextPath}/hhg/getPageListBefore",
