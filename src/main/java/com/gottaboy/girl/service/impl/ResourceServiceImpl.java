...
import com.gottaboy.girl.dao.ResourceMapper;
...
public class ResourceServiceImpl implements IResourceService {
	...
	public Resource createResource(Resource resource) {
		int ret = resourceDao.insert(resource);
		return resource;
	}

	@Override
	public Resource updateResource(Resource resource) {
		int ret = resourceDao.updateByPrimaryKey(resource);
		return resource;
	}
	...
	public void deleteResource(Long resourceId) {
		...
		resourceDao.deleteDescendants(resource.makeSelfAsParentIds() + "%");
	}
